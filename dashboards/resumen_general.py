...
def resumen_general(df_selection):
    ...
    total_distance_by_player = (
        df_selection.groupby("Dia")["Total Distance"].agg("sum")
    )
    ...
    total_hi_distance_by_player = (
        df_selection.groupby("Dia")["Dist +17 km/h"].agg("sum")
    )
    ...
    total_hsr_distance_by_player = (
        df_selection.groupby("Dia")["Velocity Band 6 Total Distance"].agg("sum")
    )
